...
import static constantandutil.Base64.*;
import static constantandutil.Constant.URL_gaitou;
import static constantandutil.Constant.pathbase;

public class GaitouActivity extends BaseActivity implements View.OnClickListener{
    //用来表示子活动
    public static final int TAKE_PHOTO=1;
    public static final int CHOOSE_PHOTO=2;
    public static final int PICCUT=3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gaitou);
        picture=findViewById(R.id.GaitouImage);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.choose:
                ...
                if (ContextCompat.checkSelfPermission(GaitouActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions(GaitouActivity.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }else {
                    openAlbum();
                }
                break;
    ...
    private void takephoto() {
        ...
        if (Build.VERSION.SDK_INT>=24){
            imageUri= FileProvider.getUriForFile(GaitouActivity.this,"com.example.danganguan.fileprovider",outputImage);
        }else {
                        ...
                        public void onFailure(Call call, IOException e) {
                            if (e instanceof SocketTimeoutException) {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(GaitouActivity.this,"连接超时，请稍后重试",Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                            if (e instanceof ConnectException) {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(GaitouActivity.this,"连接错误，请检查您的网络",Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        }
                        ...
                        public void onResponse(Call call, Response response) throws IOException {
                            ...
                            if (model.code==200){
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(GaitouActivity.this,model.message,Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        }
